...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1834397260;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<Comic>> crateApiListComics({
  ...
  Future<void> crateApiPrefetchPageVariants({
  ...
  Future<RenderedPage> crateApiRenderPagePreview({
    required PlatformInt64 chapterId,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<Comic>> crateApiListComics({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_comic,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiListComicsConstMeta,
  ...
  TaskConstMeta get kCrateApiListComicsConstMeta => const TaskConstMeta(
    debugName: "list_comics",
  ...
  Future<void> crateApiPrefetchPageVariants({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_prefetch_page_variants_payload(
            payload,
            serializer,
          );
          pdeCallFfi(
        ...
        constMeta: kCrateApiPrefetchPageVariantsConstMeta,
        argValues: [payload],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPrefetchPageVariantsConstMeta =>
      const TaskConstMeta(
        debugName: "prefetch_page_variants",
        argNames: ["payload"],
      );
  ...
  Future<RenderedPage> crateApiRenderPagePreview({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRenderPagePreviewConstMeta,
        argValues: [chapterId, pageIndex],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiRenderPagePreviewConstMeta => const TaskConstMeta(
    debugName: "render_page_preview",
    argNames: ["chapterId", "pageIndex"],
  );
  ...
  dco_decode_box_autoadd_prefetch_page_variants_payload(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_prefetch_page_variants_payload(raw);
  }
  ...
  Comic dco_decode_comic(dynamic raw) {
    ...
    return Comic(
      id: dco_decode_i_64(arr[0]),
      libraryId: dco_decode_i_64(arr[1]),
      ...
      chapterCount: dco_decode_i_64(arr[7]),
      readChapterCount: dco_decode_i_64(arr[8]),
      inProgressChapterCount: dco_decode_i_64(arr[9]),
    );
  }
  ...
  ImageVariantProfile dco_decode_image_variant_profile(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ImageVariantProfile.values[raw as int];
  }
  ...
  List<Comic> dco_decode_list_comic(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_comic).toList();
  }
  ...
  PrefetchPageVariantsPayload dco_decode_prefetch_page_variants_payload(
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return PrefetchPageVariantsPayload(
      chapterId: dco_decode_i_64(arr[0]),
      pageIndices: dco_decode_list_prim_u_32_strict(arr[1]),
      targetWidth: dco_decode_opt_box_autoadd_u_32(arr[2]),
      profile: dco_decode_image_variant_profile(arr[3]),
    );
  }
  ...
  RawComic dco_decode_raw_comic(dynamic raw) {
    ...
    return RawComic(
      ...
      libraryPath: dco_decode_String(arr[4]),
      dateModified: dco_decode_i_64(arr[5]),
      chapterCount: dco_decode_i_64(arr[6]),
      readChapterCount: dco_decode_i_64(arr[7]),
      inProgressChapterCount: dco_decode_i_64(arr[8]),
    );
  }
  ...
  sse_decode_box_autoadd_prefetch_page_variants_payload(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_prefetch_page_variants_payload(deserializer));
  }
  ...
  Comic sse_decode_comic(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_id = sse_decode_i_64(deserializer);
    var var_libraryId = sse_decode_i_64(deserializer);
    var var_title = sse_decode_String(deserializer);
  ...
  ImageVariantProfile sse_decode_image_variant_profile(
    ...
    return ImageVariantProfile.values[inner];
  }
  ...
  List<Comic> sse_decode_list_comic(SseDeserializer deserializer) {
    ...
    var ans_ = <Comic>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_comic(deserializer));
    }
    return ans_;
  }
  ...
  PrefetchPageVariantsPayload sse_decode_prefetch_page_variants_payload(
    ...
    var var_profile = sse_decode_image_variant_profile(deserializer);
    return PrefetchPageVariantsPayload(
      chapterId: var_chapterId,
  ...
  void sse_encode_box_autoadd_prefetch_page_variants_payload(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_prefetch_page_variants_payload(self, serializer);
  }
  ...
  void sse_encode_comic(Comic self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.id, serializer);
    sse_encode_i_64(self.libraryId, serializer);
    sse_encode_String(self.title, serializer);
  ...
  void sse_encode_list_comic(List<Comic> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_comic(item, serializer);
    }
  }
  ...
  void sse_encode_prefetch_page_variants_payload(
    ...
    sse_encode_image_variant_profile(self.profile, serializer);
  }
