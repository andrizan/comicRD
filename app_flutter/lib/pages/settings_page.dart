...
class _SettingsPageState extends ConsumerState<SettingsPage> {
                        ...
                        Row(
                          children: [
                            FButton(
                              ...
                              child: Text(
                                _scanning ? text.scanning : text.scanLibrary,
                              ),
                            ),
                            if (_scanStatus != null) ...[
                              const SizedBox(width: 12),
  ...
  Widget _sectionHeader(String label) {
    return Padding(
      ...
      child: Text(
        label,
        style: context.appSubtitleStyle.copyWith(fontWeight: FontWeight.w600),
      ),
    );
  }
